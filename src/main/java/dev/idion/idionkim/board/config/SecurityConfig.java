...
import dev.idion.idionkim.board.oauth.ClientResources;
import dev.idion.idionkim.board.oauth.UserTokenService;
...
import static dev.idion.idionkim.board.domain.enums.SocialType.*;
